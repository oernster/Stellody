...
class PositionBar(QWidget):
    ...
    def __init__(
        ...
        # A track's stars used to sit here too. They moved into a column of
    ...
    def show_plays(self, record: Listening | None) -> None:
        """Show one track's play count; nothing while there is no track.

        Worded by the same function the plays column is, so the two cannot
